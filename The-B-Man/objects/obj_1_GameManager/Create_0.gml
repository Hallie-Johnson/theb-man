...
ds_list_add(wave1, obj_Battle_Enemy_Fighter);
ds_list_add(wave1, 1);
...
ds_list_add(wave2, 2);
ds_list_add(wave2, obj_Battle_Enemy_Ranged);
ds_list_add(wave2, 1);
ds_list_add(wave_config, wave2);

// Wave 3
var wave3 = ds_list_create();
ds_list_add(wave3, obj_Battle_Enemy_Ranged);
ds_list_add(wave3, 2);
ds_list_add(wave3, obj_Battle_Enemy_Tank);
ds_list_add(wave3, 1);
