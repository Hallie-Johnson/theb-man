...
if (obj_clue_manager.selected_folder == 1) {
	if (complete) {
		global.clues_unlocked[1] = 1;
		complete = false;
	}
	
	if (global.battle_1_clues >= 1) {
		if (global.clues_unlocked[1] == 1) {
...
if (obj_clue_manager.selected_folder == 2) {
	if (complete) {
		global.clues_unlocked[10] = 1;
		complete = false;
	}
	
	if (global.driving_1_clues >= 1) {
		if (global.clues_unlocked[10] == 1) {
			sprite_index = spr_clue_complete;
		}
		else sprite_index = spr_clue_unlocked;
	} else {
...
if (obj_clue_manager.selected_folder == 3) {
	if (complete) {
		global.clues_unlocked[19] = 1;
		complete = false;
	}
	
	if (global.flying_1_clues >= 1) {
		if (global.clues_unlocked[19] == 1) {
			sprite_index = spr_clue_complete;
		}
		else sprite_index = spr_clue_unlocked;
	} else {
...
//show_debug_message(string(global.clues_unlocked));