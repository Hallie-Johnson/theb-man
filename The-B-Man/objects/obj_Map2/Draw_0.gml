...
if (selected) {
	...
	draw_text(room_width/2 - 500, room_height/2 - 250, "MISSION 4");
	draw_text(room_width/2, room_height/2 - 250, "MISSION 5");
	draw_text(room_width/2 + 500, room_height/2 - 250, "MISSION 6");
