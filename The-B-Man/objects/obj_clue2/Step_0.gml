...
if (obj_clue_manager.selected_folder == 1) {
	if (complete) {
		global.clues_unlocked[2] = 1;
		complete = false;
	}
	
	if (global.battle_1_clues >= 2) {
		if (global.clues_unlocked[2] == 1) {
...
if (obj_clue_manager.selected_folder == 2) {
	if (complete) {
		global.clues_unlocked[11] = 1;
		complete = false;
	}
	
	if (global.driving_1_clues >= 2) {
		if (global.clues_unlocked[11] == 1) {
			sprite_index = spr_clue_complete;
		}
		else sprite_index = spr_clue_unlocked;
	} else {
...
if (obj_clue_manager.selected_folder == 3) {
	if (complete) {
		global.clues_unlocked[20] = 1;
		complete = false;
	}
	
	if (global.flying_1_clues >= 2) {
		if (global.clues_unlocked[20] == 1) {
			sprite_index = spr_clue_complete;
		}
		else sprite_index = spr_clue_unlocked;
	} else {
