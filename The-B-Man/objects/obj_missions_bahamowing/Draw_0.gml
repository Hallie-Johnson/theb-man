...
if (clicked) {
	...
	draw_sprite_ext(spr_icon_bahamowing, 0, room_width/2, room_height/2 - 50, 10, 10, 0, c_white, 1);
	draw_sprite_ext(spr_icon_bahamowing, 7, room_width/2 - 500, room_height/2 - 50, 10, 10, 0, c_white, 1);
