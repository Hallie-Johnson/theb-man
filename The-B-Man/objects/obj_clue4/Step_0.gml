...
if (obj_clue_manager.selected_folder == 1) {
	if (complete) {
		global.clues_unlocked[4] = 1;
		complete = false;
	}
	
	if (global.battle_2_clues >= 1) {
		if (global.clues_unlocked[4] == 1) {
...
if (obj_clue_manager.selected_folder == 2) {
	if (complete) {
		global.clues_unlocked[13] = 1;
		complete = false;
	}
	
	if (global.driving_2_clues >= 1) {
		if (global.clues_unlocked[13] == 1) {
			sprite_index = spr_clue_complete;
		}
		else sprite_index = spr_clue_unlocked;
	} else {
...
if (obj_clue_manager.selected_folder == 3) {
	if (complete) {
		global.clues_unlocked[22] = 1;
		complete = false;
	}
	
	if (global.flying_2_clues >= 1) {
		if (global.clues_unlocked[22] == 1) {
			sprite_index = spr_clue_complete;
		}
		else sprite_index = spr_clue_unlocked;
	} else {
