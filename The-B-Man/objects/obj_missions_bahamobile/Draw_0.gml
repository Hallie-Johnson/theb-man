...
if (clicked) {
	...
	draw_sprite_ext(spr_icon_bahamobile, 7, room_width/2 - 500, room_height/2 - 50, 10, 10, 0, c_white, 1);
	draw_sprite_ext(spr_icon_bahamobile, 0, room_width/2 + 500, room_height/2 - 50, 10, 10, 0, c_white, 1);
