...
if (draw_upgrades) {
	...
	draw_text(175, 200, "HEALTH LVL. " + string(global.upgrade_wing_health) + "/3");
	
	if (global.upgrade_points > 0) {
		if (global.upgrade_wing_health == 0) {
			draw_sprite_ext(spr_upgrade_button, 0, 170, 250, 7, 7, 0, c_white, 1);
		} else if (global.upgrade_wing_health == 1) {
			draw_sprite_ext(spr_upgrade_button, 1, 170, 250, 7, 7, 0, c_white, 1);
		} else if (global.upgrade_wing_health == 2) {
	...
	if (global.upgrade_wing_health == 3) {
	...
	draw_text(175, 400, "DAMAGE LVL. " + string(global.upgrade_wing_damage) + "/3");
	
	if (global.upgrade_points > 0) {
		if (global.upgrade_wing_damage == 0) {
			draw_sprite_ext(spr_upgrade_button, 0, 170, 450, 7, 7, 0, c_white, 1);
		} else if (global.upgrade_wing_damage == 1) {
			draw_sprite_ext(spr_upgrade_button, 1, 170, 450, 7, 7, 0, c_white, 1);
		} else if (global.upgrade_wing_damage == 2) {
	...
	if (global.upgrade_wing_damage == 3) {
	...
	if (mousex > 170 && mousex < 500 && mousey > 450 && mousey < 575) {
		if (mouse_check_button_pressed(mb_left)) {
			...
			if (global.upgrade_points > 0 && global.upgrade_wing_damage < 3) {
				if (global.sound_effects) audio_play_sound(snd_sfx_upgrade, 1, false);
				global.upgrade_points--;
				global.upgrade_wing_damage++;
				instance_create_layer(x, y, "Save", obj_Save);
			}
	...
	draw_text(175, 600, "SPEED LVL. " + string(global.upgrade_wing_speed) + "/3");
	
	if (global.upgrade_points > 0) {
		if (global.upgrade_wing_speed == 0) {
			draw_sprite_ext(spr_upgrade_button, 0, 170, 650, 7, 7, 0, c_white, 1);
		} else if (global.upgrade_wing_speed == 1) {
			draw_sprite_ext(spr_upgrade_button, 1, 170, 650, 7, 7, 0, c_white, 1);
		} else if (global.upgrade_wing_speed == 2) {
	...
	if (global.upgrade_wing_speed == 3) {
	...
	if (mousex > 170 && mousex < 500 && mousey > 650 && mousey < 775) {
		if (mouse_check_button_pressed(mb_left)) {
			...
			if (global.upgrade_points > 0 && global.upgrade_wing_speed < 3) {
				if (global.sound_effects) audio_play_sound(snd_sfx_upgrade, 1, false);
				global.upgrade_points--;
				global.upgrade_wing_speed++;
				instance_create_layer(x, y, "Save", obj_Save);
			}
